...
import 'package:grocery/Presentation/common/mult_line_text_field.dart';
...
import 'package:grocery/Presentation/views/home/dashboard/components/multi_select_drop_down.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              BlocListener<EventCubit, EventState>(listener: (context, state) {
                if (state.status == EventEnum.success) {
                  SnackBarWidget.buildSnackBar(
                    context,
                    AppStrings.eventAddedSuccessText,
                        ...
                        onTap: () async {
                          if (formKey.currentState!.validate()) {
                            if (beginDateTime == null) {
                              SnackBarWidget.buildSnackBar(
                                context,
                                AppStrings.selectBeginDateText,
                                AppColors.redColor,
                                Icons.close,
                                true,
                              );
                              ...
                              await context.read<EventCubit>().addEvent(map);
                            }
                          }
                        }),
                  );
